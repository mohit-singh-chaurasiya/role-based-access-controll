...
const Login = () => {
  ...
  return (
    <div className="login-section align-content-center" style={{background:"#c7ecee"}}>
      <Container>
        <Row className="justify-content-center" >
          <Col xl={4} lg={5} md={7} xs={12}>
            <div className="login-box rounded p-4 shadow-sm "  style={{background:"transparent",border:'2px solid black',padding:18,boxShadow:'5px 5px 15px 5px grey'}} >
